---
title: Why I like using CircleCI for building Haskell web services
author: dmj`
tags: haskell, circleci
---

For work I'm building a Haskell based REST API using the latest Snap
1.0 server. 
